 ...
 *
 * Algorithm:
 * Accompanying with Merge Sort, we can count the # of inversions at
 * the same time in the merging step.
 */
...
public class InversionCounter {
     ...
     */
    private static int mergeSortHelper(int[] nums, int left, int right, int[] aux) {
        // Base case
        if (left == right) {
            return 0;
        }
     ...
     */
    private static int merge(int[] nums, int left, int mid, int right, int[] aux) {
