Application of *"Focus on some computationally tractable special cases"* and *"Solve in exponential-time, but faster than brute-force way"*  to deal with NP-complete problems
